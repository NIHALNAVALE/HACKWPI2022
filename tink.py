...
app=Tk()
app.title("Data Logger using OpenCV")
...
label = Label(app, text="Click 'Enter' button to display the images and save the file as a .csv")
label.pack()

#load = Image.open("example.jpg")
#render = PhotoImage(load)
#img = Label(self, image = render)
#img.image = render
#img.place (x=0,y=0)
#label = Label(app, text="This is the images")
#label.pack()
